...
# in the "right partition"; it doesn't need to appear between the left and right partition.
# EXAMPLE
...
def partiziona(ll:LinkedList, x:int) -> LinkedList:
...
def test_lr_partition():
    partitioners = [partiziona, lr_partition]
